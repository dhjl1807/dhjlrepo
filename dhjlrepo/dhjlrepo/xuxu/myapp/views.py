...
def go_edu(request):
    username = request.session['username']
    return render(request, 'nav/education.html', locals())


def go_salary(request):
    username = request.session['username']
    return render(request, 'nav/experience.html', locals())


def go_city(request):
    username = request.session['username']
    return render(request, 'nav/areacity.html', locals())


def go_word(request):
    username = request.session['username']
    return render(request, 'nav/wordcloud.html', locals())
